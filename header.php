...
<html lang="ru">
	<head>
		...
		<title><?php bloginfo('name'); echo " | "; bloginfo('description'); ?></title> <!-- ? Здесь мы удаляем текст между тегами и пишем код PHP, чтобы вносить изменение через панель управления WP -->
    ...
    <body class="no-svg">
        <header>
            <div class="container">
                ...
                <!-- Создаем динамическое меню вместо созданого в HTML статичного. Для этого скопировали код с wp-kama.ru и оставив те позиции кода, которые нужны нашему проекту заполняем их. -->
                <?php 
                wp_nav_menu( [
                    'menu'            => 'Main',
                    'container'       => false,
